...
/* themes/droopalines/templates/content/node.html.twig */
class __TwigTemplate_f748e1993ffdfb89a4021c7fc1f0e2a4 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("droopalines/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return "themes/droopalines/templates/content/node.html.twig";
    }
...
%}
{{ attach_library('droopalines/node') }}
...
", "themes/droopalines/templates/content/node.html.twig", "/var/www/html/web/themes/droopalines/templates/content/node.html.twig");
    }
